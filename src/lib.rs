...
#[derive(Debug)]
pub struct VoxelForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VoxelForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VoxelForge processing");
    
    let mut processor = VoxelForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VoxelForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VoxelForgeProcessor::new(false);
